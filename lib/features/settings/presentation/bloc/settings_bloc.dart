...
class SettingsState extends Equatable {
  ...
  SettingsState copyWith(
      {List<DashboardCardEntity>? dashboardCards, bool? isLoading}) {
...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  void _onCardReordered(
      DashboardCardReordered event, Emitter<SettingsState> emit) {
